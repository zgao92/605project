...
setwd("~/wisconsin/605/group3/group3")
library(knitr)
```
...
### 2. Which operator has higher winning probability?
...
### 3. Which weapon has a higher probability to win?
